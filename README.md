...
These mods were made to run on the 1.8.9 Snapshot Version of LiteLoader which could lead to instability. [1.8.9_LiteLoader_Snapshot_Version](https://www.liteloader.com/download#snapshot_1890).
